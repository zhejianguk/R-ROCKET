    ...
    with HasLogicalTreeNode
{
  ...
  val ght_packet_out_SRNode       = BundleBridgeSource[UInt](Some(() => UInt((2*GH_GlobalParams.GH_WIDITH_PACKETS).W)))
  val core_r_arfs_SRNode          = BundleBridgeSource[UInt](Some(() => UInt(144.W)))
  ...
  val ghe_packet_in_SKNode        = BundleBridgeSink[UInt](Some(() => UInt((2*GH_GlobalParams.GH_WIDITH_PACKETS).W)))
  val core_r_arfs_c_SKNode        = BundleBridgeSink[UInt](Some(() => UInt(GH_GlobalParams.GH_WIDITH_PACKETS.W)))
